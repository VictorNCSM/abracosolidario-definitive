...
<body>
    <span id="fonte">
        ...
        $nomeimg = $id_doacao + 1;
        $nome = $_FILES['file']['name']; # nome real
        $tmp = $_FILES['file']['tmp_name']; # Nome temporário
        ...
        echo 'Doação registrada com sucesso. volte à <a href="../usuario.php">área do usuário</a> ou vá à <a href="../index.html">página inicial</a>.';
        ?>
    </span>
</body>
